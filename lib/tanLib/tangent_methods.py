...
class fastsim:
    ...
    def calc_tangent_force(self, contact_patch, material_properties, slip_state, state_dyn):
        ...
        if isinstance(contact_patch, eqv_el_normal_contact):
            ...
            p_x = np.zeros((self.discratization, self.discratization))
            p_y = np.zeros((self.discratization, self.discratization))
            s_out = np.zeros((self.discratization, self.discratization))
            g_bound = np.zeros((self.discratization, self.discratization))
            s_x = np.zeros((self.discratization, self.discratization))
            s_y = np.zeros((self.discratization, self.discratization))
